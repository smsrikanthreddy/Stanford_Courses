...
wordVectors = (wordVectors0[:nWords,:] + wordVectors0[nWords:,:])
visualizeWords = ["the", "a", "an", ",", ".", "?", "!", "``", "''", "--", "good", "great", "cool", "brilliant", "wonderful", "well", "amazing",
	"worth", "sweet", "enjoyable", "boring", "bad", "waste", "dumb", "annoying"]
for word in visualizeWords:
    print('word is:-', word)
    print('word is', tokens[word])
visualizeIdx = [tokens[word] for word in visualizeWords]
print('visualizeIdx :- ', visualizeIdx)
