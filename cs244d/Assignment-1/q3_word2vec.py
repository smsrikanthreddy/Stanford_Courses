...
def softmaxCostAndGradient(predicted, target, outputVectors, dataset):
    ...
    #gradPred = np.dot(outputVectors.T, probabilities.reshape(probabilities.shape[0], 1)).flatten()
    #grad = np.dot(probabilities.reshape(probabilities.shape[0], 1), predicted.reshape(1, predicted.shape[0]))
